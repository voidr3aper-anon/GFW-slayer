...
Этот репозиторий организован в два основных способа доступа:

### 🔗 Быстрый доступ (рекомендуется для новых пользователей)
Используйте организованную структуру для удобного просмотра и выбора:
```
configs/
├── regional/           # Регионально-оптимизированные конфигурации
│   ├── china/         # 🇨🇳 Конфигурации для Китая
│   ├── iran/          # 🇮🇷 Конфигурации для Ирана  
│   └── russia/        # 🇷🇺 Конфигурации для России
└── general/           # 🌍 Универсальные конфигурации
```

### 🔄 Устаревшие URL (для существующих пользователей)
Все исходные URL подписок остаются активными и стабильными в корневом каталоге, чтобы обеспечить бесперебойную работу существующих подписок.
...
#### 🆕 Рекомендуемые URL (организованная структура)
<table>
<tr>
...
<tr>
<td><b>🌍 Общие конфигурации V2Ray</b></td>
<td>
...
<tr>
<td><b>🔥 Продвинутые конфигурации V-Force</b></td>
<td>
...
<tr>
<td><b>🇮🇷 Оптимизированные конфигурации для Ирана</b></td>
<td>
...
<tr>
<td><b>🇨🇳 Оптимизированные конфигурации для Китая</b></td>
<td>
...
<tr>
<td><b>🇷🇺 Оптимизированные конфигурации для России</b></td>
<td>
...
#### 🔄 Устаревшие URL (всё ещё активны)
Для существующих пользователей эти исходные URL продолжают работать:
<details>
<summary>Нажмите, чтобы развернуть устаревшие URL</summary>
